        ...
        <>
            <main className={`container-main flex flex-col items-center justify-center text-center ${currentTheme === 'light' ? 'img-light' : 'img-dark'} text-zinc-50 relative`}>
                ...
                <div className="absolute left-0 right-0 bottom-0 flex items-center justify-center p-5 text-4xl animate-bounce">
                    <Link aria-label="Ir para a seção Sobre" href="#sobre">
            ...
            <div id="sobre" aria-label="Seção Sobre"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="about-img flex items-center justify-center md:justify-start relative select-none mb-5 md:mb-0">
                        <Image
                            ...
                            height={50}
                            ref={ref}
                            className={`dots absolute mx-auto top-0 md:-top-10 left-0 md:-left-44 right-0 ${inView ? 'view' : ''} max-w-56 md:max-w-full`}
                            alt="Decoração em pontos para a seção sobre"
                        />
                        <Image
                            src={"/men.png"}
                            width={280}
                            ...
                            alt="Ilustação cartoon de menino andando esperançoso."
                        />
                    </div>
            ...
            <section id="stack" className={`max-w-5xl mx-auto px-5 my-20`}>
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                    <div className="bg-orange-100 text-orange-600 dark:bg-orange-700/20 border-orange-100 dark:border dark:border-orange-700/40 dark:text-orange-200 py-2 px-4 rounded-full flex items-center space-x-2" aria-label="Tecnologia Asterisk">
                        <SiAsterisk className="text-3xl" />
                        <span>Asterisk</span>
                    </div>
                    <div className="bg-gray-100 text-gray-800 dark:bg-gray-700/20 border-gray-100 dark:border dark:border-gray-700/40 dark:text-gray-300 py-2 px-4 rounded-full flex items-center space-x-2" aria-label="Tecnologia Next.js">
                        <RiNextjsLine className="text-3xl" />
                        <span>Next.js</span>
                    </div>
                    <div className="bg-green-100 text-green-600 dark:bg-green-700/20 border-green-100 dark:border dark:border-green-700/40 dark:text-green-200 py-2 px-4 rounded-full flex items-center space-x-2" aria-label="Tecnologia Node.js">
                    ...
                    <div className="bg-amber-100 text-amber-600 dark:bg-amber-700/20 border-amber-100 dark:border dark:border-amber-700/40 dark:text-amber-200 py-2 px-4 rounded-full flex items-center space-x-2" aria-label="Tecnologia Grafana">
                ...
                <div className="min-h-32 flex flex-col border dark:bg-zinc-900 rounded-lg p-5 gap-5 shadow">
                    <ul className="flex items-center justify-center min-h-12 max-h-12 gap-2">
                        <li className="flex items-center justify-center">
                            <Link aria-label="Ir para o Linkedin de Rafael Rizzo" href="https://www.linkedin.com/in/rafael-rizzo-breschi-b02547216/" target="_blank" className="p-2.5 border dark:border-zinc-800 dark:bg-zinc-950 hover:bg-zinc-700/5 dark:hover:bg-zinc-50/5 text-zinc-600 dark:text-zinc-300 rounded-lg">
                                <FaLinkedinIn />
                                <span className="sr-only">Linkedin</span>
                            </Link>
                        </li>
                        <li className="flex items-center justify-center">
                            <Link aria-label="Ir para o Instagram de Rafael Rizzo" href="https://www.instagram.com/rafael_breschi/" target="_blank" className="p-2.5 border dark:border-zinc-800 dark:bg-zinc-950 hover:bg-zinc-700/5 dark:hover:bg-zinc-50/5 text-zinc-600 dark:text-zinc-300 rounded-lg">
                                <FaInstagram />
                                <span className="sr-only">Instagram</span>
                            </Link>
                        </li>
                        <li className="flex items-center justify-center">
                            <Link aria-label="Ir para o perfil da Steam do Rafael Rizzo" href="https://steamcommunity.com/id/perfilRzz/" target="_blank" className="p-2.5 border dark:border-zinc-800 dark:bg-zinc-950 hover:bg-zinc-700/5 dark:hover:bg-zinc-50/5 text-zinc-600 dark:text-zinc-300 rounded-lg">
                                <FaSteamSymbol />
                                <span className="sr-only">Steam</span>
                            </Link>
                        </li>
                        <li className="flex items-center justify-center">
                            <Link aria-label="Ir para o Github do Rafael Rizzo" href="https://github.com/rafaelRizzo" target="_blank" className="p-2.5 border dark:border-zinc-800 dark:bg-zinc-950 hover:bg-zinc-700/5 dark:hover:bg-zinc-50/5 text-zinc-600 dark:text-zinc-300 rounded-lg">
                                <TbBrandGithub />
